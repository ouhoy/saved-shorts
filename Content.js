...
if (document.readyState !== "loading") {
  console.log("My btn: ", myBtns);
  // setTimeout(() => {
  //   $("#like-button").insertAdjacentHTML("beforeEnd", htmlMarkup);
  // }, 5000);
} else {
